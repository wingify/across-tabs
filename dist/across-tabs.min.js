 ...
 */
var a=void 0;a=function(){function e(){}return e.generate=function(){var t=e._getRandomInt,n=e._hexAligner;return n(t(32),8)+"-"+n(t(16),4)+"-"+n(16384|t(12),4)+"-"+n(32768|t(14),4)+"-"+n(t(48),12)},e._getRandomInt=function(e){return e<0?NaN:e<=30?0|Math.random()*(1<<e):e<=53?(0|Math.random()*(1<<30))+(0|Math.random()*(1<<e-30))*(1<<30):NaN},e._getIntAligner=function(e){return function(t,n){for(var a=t.toString(e),i=n-a.length,o="0";i>0;i>>>=1,o+=o)1&i&&(a=o+a);return a}},e._hexAligner=e._getIntAligner(16),e.prototype.toString=function(){return this.hexString},e}(),t.default=a},function(e,t,n){"use strict";function a(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(t,"__esModule",{value:!0});var i=n(3),o=a(i),r=n(2),s=a(r),u=n(1),d=a(u),l=n(0),f=a(l);n(12);var c={};c._onLoad=function(e){var t=void 0,n=void 0,a=e.split(f.default.LOADED)[1];if(a)try{a=s.default.config.parse(a),a.id&&(t=s.default.getAll(),t.length&&(window.newlyTabOpened=t[t.length-1],window.newlyTabOpened.id=a.id,window.newlyTabOpened.name=a.name||a.windowName))}catch(e){throw new Error(d.default.INVALID_JSON)}if(window.newlyTabOpened)try{t=s.default.getAll();var i=t.find(function(e){return e.id===window.newlyTabOpened.id});i&&(i.wasSuccessfullyLoaded=!0),n=f.default.HANDSHAKE_WITH_PARENT,n+=s.default.config.stringify({id:window.newlyTabOpened.id,name:window.newlyTabOpened.name||window.newlyTabOpened.windowName,parentName:window.name}),s.default.sendMessage(window.newlyTabOpened,n,a.isSiteInsideFrame)}catch(e){throw new Error(d.default.INVALID_JSON)}},c._onCustomMessage=function(e,t){var n=void 0,a=void 0,i=e.split(t)[1];try{i=s.default.config.parse(i)}catch(e){throw new Error(d.default.INVALID_JSON)}a={tabInfo:i,type:t},n=new CustomEvent("onCustomChildMessage",{detail:a}),window.dispatchEvent(n)},c._onBeforeUnload=function(e){var t=void 0,n=e.split(f.default.ON_BEFORE_UNLOAD)[1];try{n=s.default.config.parse(n)}catch(e){throw new Error(d.default.INVALID_JSON)}s.default.tabs.length&&(t=s.default.getAll(),window.newlyTabOpened=o.default.searchByKeyName(t,"id",n.id)||window.newlyTabOpened);var a=new CustomEvent("onChildUnload",{detail:n});window.dispatchEvent(a)},c.onNewTab=function(e){var t=e.data;return!(!t||"string"!=typeof t||!s.default.tabs.length)&&((!s.default.config.origin||s.default.config.origin===e.origin)&&void(t.indexOf(f.default.LOADED)>-1?c._onLoad(t):t.indexOf(f.default.CUSTOM)>-1?c._onCustomMessage(t,f.default.CUSTOM):t.indexOf(f.default.HANDSHAKE)>-1?c._onCustomMessage(t,f.default.HANDSHAKE):t.indexOf(f.default.ON_BEFORE_UNLOAD)>-1&&c._onBeforeUnload(t)))},t.default=c},function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=function(){function e(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=document.createEvent("CustomEvent");return n.initCustomEvent(e,!1,!1,t.detail),n}"function"!=typeof window.CustomEvent&&(e.prototype=window.Event.prototype,window.CustomEvent=e)}()},function(e,t,n){"use strict";function a(e){return e&&e.__esModule?e:{default:e}}function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(t,"__esModule",{value:!0});var o=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var a in n)Object.prototype.hasOwnProperty.call(n,a)&&(e[a]=n[a])}return e},r=function(){function e(e,t){for(var n=0;n<t.length;n++){var a=t[n];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,n,a){return n&&e(t.prototype,n),a&&e(t,a),t}}(),s=n(0),u=a(s),d=n(1),l=a(d),f=n(6),c=a(f),_=n(14),h=a(_),v=function(){function e(t){i(this,e),t||(t={}),void 0===t.handshakeExpiryLimit&&(t.handshakeExpiryLimit=5e3),void 0===t.shouldInitImmediately&&(t.shouldInitImmediately=!0),"function"!=typeof t.parse&&(t.parse=JSON.parse),"function"!=typeof t.stringify&&(t.stringify=JSON.stringify),this.tabName=window.name,this.tabId=null,this.tabParentName=null,this.storage=new h.default,o(this,t),this.config=t,this.shouldInitImmediately&&this.init()}return r(e,[{key:"_isWindowNameOverridden",value:function(){return window.name.indexOf(c.default.NEW_TAB_DATA)<0}},{key:"_parseData",value:function(e){var t=void 0;try{t=this.config.parse(e),this.tabId=t&&t.id,this.tabName=t&&t.name,this.tabParentName=t&&t.parentName,this.tabStorage=new h.default(this._isWindowNameOverridden()),this.tabStorage.set(c.default.NEW_TAB_DATA,e)}catch(e){throw new Error(l.default.INVALID_DATA)}}},{key:"onCommunication",value:function(e){var t=this,n=void 0,a=e.data;if(a&&"string"==typeof a&&(!this.config.origin||this.config.origin===e.origin)){if(window.clearTimeout(this.timeout),a.indexOf(u.default.PARENT_DISCONNECTED)>-1&&(this.config.onParentDisconnect&&this.config.onParentDisconnect(),window.removeEventListener("message",function(e){return t.onCommunication(e)})),a.indexOf(u.default.HANDSHAKE_WITH_PARENT)>-1){var i=void 0;n=a.split(u.default.HANDSHAKE_WITH_PARENT)[1],this._parseData(n),i={id:this.tabId,isSiteInsideFrame:this.config.isSiteInsideFrame},this.sendMessageToParent(i,u.default.HANDSHAKE),this.config.onInitialize&&this.config.onInitialize()}if(a.indexOf(u.default.PARENT_COMMUNICATED)>-1){n=a.split(u.default.PARENT_COMMUNICATED)[1];try{n=this.config.parse(n)}catch(e){throw new Error(l.default.INVALID_JSON)}this.config.onParentCommunication&&this.config.onParentCommunication(n)}if(a.indexOf(u.default.PARENT_COMMUNCATED_STORAGE_DATA)>-1){n=a.split(u.default.PARENT_COMMUNCATED_STORAGE_DATA)[1];try{n=this.config.parse(n),Object.entries(n).map(function(e){t.tabStorage.set(e[0],e[1])})}catch(e){throw new Error(l.default.INVALID_JSON)}}}}},{key:"addListeners",value:function(){var e=this;window.onbeforeunload=function(t){var n={id:e.tabId,isSiteInsideFrame:e.config.isSiteInsideFrame};e.sendMessageToParent(n,u.default.ON_BEFORE_UNLOAD)},window.removeEventListener("message",function(t){return e.onCommunication(t)}),window.addEventListener("message",function(t){return e.onCommunication(t)})}},{key:"setHandshakeExpiry",value:function(){var e=this;return window.setTimeout(function(){e.config.onHandShakeExpiry&&e.config.onHandShakeExpiry()},this.handshakeExpiryLimit)}},{key:"sendMessageToParent",value:function(e,t){var n=void 0;e=(t||u.default.CUSTOM)+this.config.stringify(e),window.top.opener&&(n=this.config.origin||"*",window.top.opener.postMessage(e,n))}},{key:"getTabInfo",value:function(){return{id:this.tabId,name:window.name,parentName:this.tabParentName,isSiteInsideFrame:this.config.isSiteInsideFrame}}},{key:"init",value:function(){this.addListeners(),this.sendMessageToParent(this.getTabInfo(),u.default.LOADED),this.timeout=this.setHandshakeExpiry(),this.config.onReady&&this.config.onReady()}}]),e}();t.default=v},function(e,t,n){"use strict";function a(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(t,"__esModule",{value:!0});var i=function(){function e(e,t){for(var n=0;n<t.length;n++){var a=t[n];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,n,a){return n&&e(t.prototype,n),a&&e(t,a),t}}(),o=n(15),r=function(e){return e&&e.__esModule?e:{default:e}}(o),s=function(){function e(){var t=arguments.length>0&&void 0!==arguments[0]&&arguments[0];a(this,e),this.storagePoint=t?r.default.SESSION_STORAGE:r.default.WINDOW_NAME}return i(e,[{key:"get",value:function(e){var t=void 0;switch(this.storagePoint){case r.default.WINDOW_NAME:t=JSON.parse(window.name)[e];break;case r.default.SESSION_STORAGE:t=window.sessionStorage.getItem(e)}return t}},{key:"set",value:function(e,t){switch(this.storagePoint){case r.default.WINDOW_NAME:var n=JSON.parse(window.name);n[e]=t,window.name=JSON.stringify(n);break;case r.default.SESSION_STORAGE:window.sessionStorage.setItem(e,t)}}}]),e}();t.default=s},function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var a={WINDOW_NAME:"__WINDOW_NAME__",SESSION_STORAGE:"__SESSION_STORAGE__"};t.default=a}])});